...
# ==============================================================================
# DESCRIPTION
# This script is the custom logic for an svm dr demo
#
# It will complete the vars_external dict with snapmirror relationship information
# Junctionpaths, naming conventions, etc
#
# VERSION HISTORY
