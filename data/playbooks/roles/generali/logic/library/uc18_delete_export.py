...
# ==============================================================================
# DESCRIPTION
# The custom logic used to delete an export from a volume
# 
# It's 100% the same as create export
# It's simply setting volume & svm names based on the primary volume & svm names
